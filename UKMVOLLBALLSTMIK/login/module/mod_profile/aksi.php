...
if ($module == "add"){
    ...
    $tambah     = "INSERT INTO tbl_profile (titlewebsite, titleparagraf, welcomeparagraf, author, copyright, description, keywords, icon)
                  VALUES ('$titlewebsite', '$titleparagraf', '$welcomeparagraf', '$author', '$copyright', '$description', '$keywords', '$icon')";
...
if ($module == "update"){
    ...
    $update       = "UPDATE tbl_profile SET titlewebsite='$titlewebsite', titleparagraf='$titleparagraf', welcomeparagraf='$welcomeparagraf', author='$author', copyright='$copyright', description='$description', keywords='$keywords', icon='$icon' where id_profile='$id_profile'";
